...
export default function AdminDashboard() {
    ...
    // Wrapped in useCallback so we can pass it to the Modal safely
    ...
    if (loading) {
        return (
            <div className="flex h-screen items-center justify-center font-bold text-purple-900">
                Loading Dashboard...
            </div>
        );
    }
        ...
        <div className="flex h-screen bg-[#F8FAFC]">
            ...
            <div className="flex flex-col w-full overflow-y-auto">
                ...
                <AddMemberModal
                    ...
                    onSuccess={fetchMembers} // This will trigger a refresh after adding
                    initialData={null}
                />
            </div>
        </div>
